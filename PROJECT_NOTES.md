...
- upper-leg danger zones now show a short upper-leg arc cue toward the warning zone
...
Instead, all meaningful work flows through the unified knowledge system in `PROJECT_KNOWLEDGE.md` and the external notes under `C:\\Future\\Codex_Skills\\external\\`.
